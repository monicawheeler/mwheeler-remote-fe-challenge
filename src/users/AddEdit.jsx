        ...
        <form className="form" onSubmit={handleSubmit(onSubmit)} onReset={reset}>
            ...
            <div className="form__body">
                <div className="form__field">
                    <label className="form__label t-form-label">Name</label>
                    <input
                        name="name"
                        type="text"
                        ref={register}
                ...
                <div className="form__field">
                    <label className="form__label t-form-label">Birthdate</label>
                    <input
                        name="birthdate"
                        type="text"
                        ref={register}
                ...
                <div className="form__field">
                    <label className="form__label t-form-label">Job title</label>
                    <input
                        name="jobTitle"
                        type="text"
                        ref={register}
                ...
                <div className="form__field">
                    <label className="form__label t-form-label">Country</label>
                    <select
                        name="country"
                        ref={register}
                        className={`form__input ${errors.country ? 'is-invalid' : ''}`}
                    > 
                        <option value=""></option>
                ...
                <div className="form__field">
                    <label className="form__label t-form-label">Salary</label>
                    <input
                        name="salary"
                        type="text"
                        ref={register}
